...
"""Hospital Triage Env Environment Client."""
...
class HospitalTriageEnv(
    ...
    """
    Client for the Hospital Triage Env Environment.
    ...
    Example with Docker:
        ...
        >>> client = HospitalTriageEnv.from_docker_image("hospital_triage_env-env:latest")
        >>> try:
        ...     result = client.reset()
